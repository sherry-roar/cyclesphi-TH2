...
output=${ROOT_DIR}/install/cyclesphi33_gpu_unimem_credit
src=${ROOT_DIR}/src
...
#-----------blender_client--------------
mkdir ${ROOT_DIR}/build/cyclesphi33_gpu_unimem_credit
cd ${ROOT_DIR}/build/cyclesphi33_gpu_unimem_credit
...
make_d="${make_d} -DWITH_CUDA_STAT=ON"
make_d="${make_d} -DWITH_CUDA_STATv2=ON"
...
cp ${ROOT_DIR}/build/cyclesphi33_gpu_unimem_credit/cycles_cuda/*.cubin ${output}/lib/.
