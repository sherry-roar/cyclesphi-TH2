 ...
 *
 */
#ifndef __KERNEL_OPTIX_H__
#define __KERNEL_OPTIX_H__
...
//};
//
// extern OptixMpiData *mpiData;
//

//#define OptixMpiData CudaMpiData
//#define mpiData cuda_mpiData
//#define DEVICE_ID CUDA_DEVICE_ID
...
#if defined(WITH_CLIENT_OPTIX_CPU_STAT)
...
//#  ifdef WITH_CLIENT_OPTIX_CPU_STAT
//
...
void mem_copy_to(
    int numDevice, char *mem, DEVICE_PTR dmem, size_t memSize, char *signal_value);
void mem_copy_from(
...
void tex_free(
    int numDevice, DEVICE_PTR kg_bin, const char *name, DEVICE_PTR dmem, size_t memSize);
