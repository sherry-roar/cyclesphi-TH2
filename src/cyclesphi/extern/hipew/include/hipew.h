...
typedef hipError_t HIPAPI thipMemAdvise (hipDeviceptr_t dev_ptr, size_t count, hipMemoryAdvise advice, int device);
typedef hipError_t HIPAPI thipMemPrefetchAsync (hipDeviceptr_t dev_ptr, size_t count, int device, hipStream_t stream);
