...
static void rna_def_scene_render_data(BlenderRNA *brna)
{
  ...
  static const EnumPropertyItem perf_caching_items[] = {
      {0, "OFF", 0, "Off", ""},
      {1, "RECORD", 0, "Record", ""},
      {2, "PLAY", 0, "Play", ""},
      {0, NULL, 0, NULL, NULL},
  ...
  //col.prop(rd, "use_only_selected_object", text="Update only selected")
  prop = RNA_def_property(srna, "use_only_selected_object", PROP_INT, PROP_NONE);
  RNA_def_property_int_sdna(prop, NULL, "use_only_selected_object");
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_range(prop, 0, 1);
  RNA_def_property_ui_text(prop, "use_only_selected_object", "use_only_selected_object");
  RNA_def_property_update(prop, NC_SCENE | ND_RENDER_OPTIONS, NULL);

  //col.prop(rd, "current_frame_preview", text="Preview frame")
  prop = RNA_def_property(srna, "current_frame_preview", PROP_INT, PROP_NONE);
  RNA_def_property_int_sdna(prop, NULL, "current_frame_preview");
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_range(prop, 0, 1000);
  RNA_def_property_ui_text(prop, "current_frame_preview", "current_frame_preview");
  RNA_def_property_update(prop, NC_SCENE | ND_RENDER_OPTIONS, NULL);

  //col.prop(rd, "enable_caching", text="Caching")
  prop = RNA_def_property(srna, "enable_caching", PROP_ENUM, PROP_NONE);
  RNA_def_property_enum_sdna(prop, NULL, "enable_caching");
  //RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  //RNA_def_property_range(prop, 0, 2);
  RNA_def_property_enum_items(prop, perf_caching_items);
  RNA_def_property_ui_text(prop, "Caching", "Caching");
  RNA_def_property_update(prop, NC_SCENE | ND_RENDER_OPTIONS, NULL);
