...
#if defined(WITH_CLIENT_SHOW_STAT)

/*goya-gogh*/
#  define SHOW_STAT_COLOR_PICKER \
    float color_picker[3 * 17] = { \
        0.435294f, 0.062745f, 0.039215f, 0.560784f, 0.27058f,  0.133333f, 0.262745f, 0.0f, \
        0.121568f, 0.333333f, 0.439215f, 0.521568f, 0.498039f, 0.517647,  0.298039f, 0.349019f, \
        0.337254f, 0.2f,      0.874509f, 0.729411f, 0.380392f, 0.6f,      0.627450f, 0.729411f, \
        0.925490f, 0.831372f, 0.541176f, 0.823529f, 0.917647f, 0.925490f, 0.850980f, 0.921568f, \
        0.529411f, 0.482352f, 0.768627f, 0.701960f, 0.776470f, 0.333333f, 0.207843f, 0.627450f, \
        0.203921f, 0.345098f, 0.003921f, 0.227450f, 0.576470f, 0.517647f, 0.533333f, 0.090196f, \
        1.0f,      1.0f,      1.0f};

/*0.192156f, 0.364705f, 0.501960f};*/
...
#  define DECLARE_FILM_CONVERT_KERNEL(variant) \
    DEVICE_KERNEL_FILM_CONVERT_##variant, DEVICE_KERNEL_FILM_CONVERT_##variant##_HALF_RGBA, \
        DEVICE_KERNEL_FILM_CONVERT_##variant##_BYTE_RGBA, \
        DEVICE_KERNEL_FILM_CONVERT_##variant##_BYTE_YUV
#else
#  define DECLARE_FILM_CONVERT_KERNEL(variant) \
    DEVICE_KERNEL_FILM_CONVERT_##variant, DEVICE_KERNEL_FILM_CONVERT_##variant##_HALF_RGBA
#endif
