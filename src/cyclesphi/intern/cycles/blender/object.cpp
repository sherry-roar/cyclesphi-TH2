...
void BlenderSync::sync_objects(BL::RenderSettings &b_render,
...
//#ifdef WITH_CLIENT_BLENDERSYNC_BORDER
  if (!b_render.use_only_selected_object()) {
//#endif    
...
//#ifdef WITH_CLIENT_BLENDERSYNC_BORDER
    bool select = Object_select_get_func((::Object *)b_ob.ptr.data, NULL, (::ViewLayer *)b_view_layer.ptr.data);

    if (b_render.use_only_selected_object() && !select) {
      continue;
    }
//#endif
                              ...
                              void **python_thread_state)
{
  ...
  if (scene->need_motion() != Scene::MOTION_PASS &&
    ...
    sync_objects(b_render, b_depsgraph, b_v3d);
  }
  ...
  foreach (float relative_time, motion_times) {
    ...
    /* sync object */
    sync_objects(b_render, b_depsgraph, b_v3d, relative_time);
  }
