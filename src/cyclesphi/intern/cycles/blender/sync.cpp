...
#if defined(WITH_CLIENT_CACHE) && !defined(WITH_CLIENT_RENDERENGINE_SENDER)
  cyclesphi::kernel::client::frame_info(
      frame, b_render.current_frame_preview(), b_render.enable_caching());
#endif
...
void BlenderSync::sync_integrator(BL::ViewLayer &b_view_layer, bool background)
{
  ...
  integrator->set_max_volume_bounds_bounce(get_int(cscene, "volume_bounds_bounces"));
