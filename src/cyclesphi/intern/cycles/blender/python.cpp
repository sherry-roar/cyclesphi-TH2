...
static PyObject *get_device_types_func(PyObject * /*self*/, PyObject * /*args*/)
{
  ...
  bool has_cuda = false, has_optix = false, has_hip = false, has_metal = false, has_oneapi = false, has_client = false;
  foreach (DeviceType device_type, device_types) {
    ...
    has_client |= (device_type == DEVICE_CLIENT);
  }
  ...
  PyTuple_SET_ITEM(list, 5, PyBool_FromLong(has_client));
  return list;
}
...
static PyObject *set_device_override_func(PyObject * /*self*/, PyObject *arg)
{
  ...
  else if (override == "CLIENT") {
    BlenderSession::device_override = DEVICE_MASK_CLIENT;
  }
  else {
