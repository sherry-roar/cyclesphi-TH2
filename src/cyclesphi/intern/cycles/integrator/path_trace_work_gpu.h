...
class PathTraceWorkGPU : public PathTraceWork {
 ...
 protected:
  ...
  ////////////////////////////////////
    ...
    (defined(WITH_CLIENT_CUDA) || defined(WITH_CLIENT_OPTIX) || defined(WITH_CLIENT_HIP))
 public:
...
#  ifdef WITH_CLIENT_HIP
  HIPDevice &hip_device() const;
  void queue_set_stream(hipStream_t s);
#endif

#    if defined(WITH_CLIENT_CUDA) || defined(WITH_CLIENT_OPTIX)
  CUDADevice &cuda_device() const;
  void queue_set_stream(CUstream s);
#  endif
  
  void kernels_use_stat(bool us);
