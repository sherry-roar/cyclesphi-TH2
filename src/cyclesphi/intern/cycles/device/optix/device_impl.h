...
//#define BLENDER_CLIENT_OPTIX_LOGGING
...
class OptiXDevice : public CUDADevice {
 ...
 public:
  ...
  std::map<unsigned long long, OptixTraversableHandle> map_instances_buildinout;
#else
...
class OptiXDevices {
 public:
  ...
  OptiXDevice &operator[](int64_t index)
  {
    return devices_[index];
  }

 private:
  OptiXDevice devices_[16];
  int size_;
};
#  endif
