...
#  ifdef BLENDER_CLIENT
  cu_assert(cuCtxGetCurrent(&cuContext));
#  endif
...
#ifdef BLENDER_CLIENT
  destination.offset = buffer_params.offset + buffer_params.window_x +
                       buffer_params.window_y * buffer_params.stride;
  destination.stride = buffer_params.stride;
#else
...
#  ifdef BLENDER_CLIENT
  const int buffer_offset = (buffer_params.offset + buffer_params.window_x +
                      buffer_params.window_y * buffer_params.stride) *
                     buffer_params.pass_stride;
# endif
  ...
  /* Color pass. */
  {
    ...
    color_layer.data = context.render_buffers->buffer.device_pointer +
                       (buffer_offset + pass_denoised) * sizeof(float);
#else
    color_layer.data = context.render_buffers->buffer.device_pointer +
