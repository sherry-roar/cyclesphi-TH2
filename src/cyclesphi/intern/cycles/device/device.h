...
#  endif
  ...
  virtual BVHLayoutMask get_bvh_layout_mask()
  {
    return 1 << 0;  // BVH_LAYOUT_BVH2; //TODO
  };
...
enum DeviceTypeMask {
  ...
  DEVICE_MASK_CLIENT = (1 << DEVICE_CLIENT),
  DEVICE_MASK_ALL = ~0
};
...
class Device {
 ...
 public:
  ...
  virtual void generic_copy_dtod(device_ptr mem1, device_ptr mem2, size_t memory_size)
  {
  }
 ...
 private:
  ...
  static vector<DeviceInfo> client_devices;
