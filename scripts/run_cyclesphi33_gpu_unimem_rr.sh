...
export KERNEL_CUDA_CUBIN=${ROOT}/install/cyclesphi33_gpu_unimem_rr/lib/kernel_sm_80.cubin
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:${ROOT}/install/cyclesphi33_gpu_unimem_rr/lib
...
mpirun --allow-run-as-root $ROOT/install/cyclesphi33_gpu_unimem_rr/bin/blender_client
